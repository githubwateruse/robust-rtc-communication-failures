...
def get_reward_combined_strategy(params_SV0, params_T2, params_T3, params_T4, params_T6, General_Patterns):
    ...
    for t in range (EP_LEN):
        if Obs_pattern_T2[t] == 0 and Obs_pattern_T3[t] == 0 and Obs_pattern_T4[t] == 0 and Obs_pattern_T6[t] == 0:
            input_state = np.array([Storm_state[0],  Storm_state[1], Storm_state[2],  Storm_state[3]])
            Orifice_setting = get_action(params_SV0, input_state)
...
if __name__ == "__main__":
    ...
    for seed in range(10):
        ...
        params_SV0 = Net_shapes_vs_params("SV0", policy_index_SV0, 4, 4)
        ...
        Weighted_CSO_Volume_series, Total_CSO_Volume_series = get_reward_combined_strategy(params_SV0, params_T2, params_T3, params_T4, params_T6, General_Patterns)
        ...
        output_path = REPO_ROOT / "data_required" / "simulation_outputs" / "sv0_tx_switching" / f"{duration}_pattern_{parallel_num}.xlsx"
