...
def get_reward_combined_strategy(params_SV2, params_T2, params_T3, params_T4, params_T6, General_Patterns):
...
if __name__ == "__main__":
    ...
    for seed in range(10):
        ...
        Weighted_CSO_Volume_series, Total_CSO_Volume_series = get_reward_combined_strategy(params_SV2, params_T2, params_T3, params_T4, params_T6, General_Patterns)
        ...
        output_path = REPO_ROOT / "data_required" / "simulation_outputs" / "sv2_tx_total_volume_priority" / f"{duration}_pattern_{parallel_num}.xlsx"
